...
import br.com.techcorp.ai.impl.ClassificadorHuggingFace;
 ...
 * e-mails por setor usando o sistema de IA avançada.
 */
@RestController
...
public class ControladorClassificacao {
    ...
    private final ClassificadorHuggingFace classificadorHuggingFace;

    @Autowired
    public ControladorClassificacao(
            ClassificadorHuggingFace classificadorHuggingFace) {
        this.classificadorHuggingFace = classificadorHuggingFace;
        this.classificador = classificadorHuggingFace; // Usar o classificador avançado como principal
    }
    ...
    public ResponseEntity<Map<String, Object>> classificarEmail(
        ...
        try {
            ...
            if (email == null ||
                ...
                (email.getCorpo() == null || email.getCorpo().trim().isEmpty())) {
            ...
            System.out.println("🤖 Classificando e-mail com IA HuggingFace: " +
                             (email.getAssunto() != null ? email.getAssunto().substring(0, Math.min(100, email.getAssunto().length())) : "") + "...");
            ...
            resposta.put("modeloIA", Map.of(
                ...
                "precisaoPorcentagem", String.format("%.1f%%", classificadorHuggingFace.getPrecisao() * 100)
            ));
    ...
    public ResponseEntity<Map<String, Object>> classificarTexto(
        ...
        try {
            ...
            System.out.println("🤖 Classificando texto com IA HuggingFace: " + texto.substring(0, Math.min(100, texto.length())) + "...");
    ...
    public ResponseEntity<Map<String, Object>> health() {
        ...
        resposta.put("tipoModelo", "HuggingFace Transformers");
